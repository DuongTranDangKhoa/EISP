...
ALTER TABLE [Transaction] ADD CONSTRAINT FKTransactio687479 FOREIGN KEY (OrderId) REFERENCES [Order] (Id);
...
ALTER TABLE OrderDetail ADD CONSTRAINT FKOrderDetai221089 FOREIGN KEY (OrderId) REFERENCES [Order] (Id);
